...
export const metadata: Metadata = {
  title: "Algemene voorwaarden - Baasy",
  description:
    "Lees de algemene voorwaarden van Baasy. Duidelijke afspraken over gebruik, privacy, aansprakelijkheid en meer.",
};
          ...
          <div className="max-w-none mx-auto pb-10">
            <div className="grid grid-cols-1 sm:grid-cols-4">
              <div className="sm:col-start-2 sm:col-span-2 prose prose-neutral dark:prose-invert max-w-none">
                ...
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                  In deze voorwaarden gebruiken we de je-vorm. Met ‘jij’, ‘je’ of ‘jouw’ bedoelen we jou als gebruiker van onze diensten (online applicatie, apps en/of website). Met ‘wij’, ‘we’, ‘ons’ of ‘onze’ bedoelen we Baasy, ingeschreven bij de Kamer van Koophandel onder nummer 89112393 en BTW-nummer NL004693041B93. Je kunt ons bereiken via info@baasy.nl of +31 6 13665348.
                </p>

                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">3. Gebruik van de website en software</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                  Het gebruik van onze website en software is volledig voor eigen risico. De functionaliteiten van onze software worden geleverd zoals beschikbaar ("as is"). Wij kunnen niet garanderen dat de software foutloos werkt of vrij is van technische storingen of beveiligingsproblemen. De geboden informatie en functies vervangen geen juridisch, boekhoudkundig of financieel advies. Wij raden aan om belangrijke beslissingen niet uitsluitend te baseren op de inhoud van onze software of website, maar altijd aanvullend advies in te winnen bij een deskundige.
                </p>

                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">4. Aanmaken van een gebruikersaccount</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">5. Proefperiode en fair-use</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                  De eerste maand nadat je een account hebt aangemaakt, kun je Baasy kosteloos proberen (m.u.v. optionele betaalde diensten). In deze periode kun je beoordelen of Baasy past bij jouw wensen en onderneming. Bevalt het niet, dan kun je tussentijds stoppen. De proefperiode wordt omgezet in een abonnement op het moment dat je je betalingsgegevens hebt toegevoegd.
                </p>
                <h3 className="mt-8 text-xl font-semibold">5.1 Fair-use policy</h3>
                <p>
                Voor het gebruik van je account geldt een fair‑use beleid. Gebruik dat in verhouding tot normaal gebruik buitensporig is, kunnen we beperken of blokkeren. Dit omvat onder meer het (geautomatiseerd) scrapen of crawlen van de applicatie, het massaal opvragen, kopiëren, spiegelen of anderszins dupliceren van door Baasy aangeboden data of content, het omzeilen van technische beschermingsmaatregelen en iedere handeling die onevenredige belasting van onze infrastructuur veroorzaakt.                </p>

                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">6. Prijsmodel en facturatieperiode</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">7. Stoppen met Baasy en verwijderen van data</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
Bij het verwijderen van je account verwijderen we automatisch na 24 uur al je data. Je kan je account verwijderen door contact met ons op te nemen via info@baasy.nl. We zullen binnen 24 uur op verwijderingsverzoeken reageren, ook in het weekend.          </p>
                <p>
Via dit e-mailadres kan je ook verzoeken voor dataportabiliteit of inzage indienen. Deze verzoeken behandelen we binnen 5 werkdagen.                </p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">8. Prijswijzigingen</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">9. Beschikbaarheid, onderhoud en functionaliteiten</h2>
                <p>
                  We doen er alles aan om Baasy prettig en betrouwbaar te laten werken. We streven naar hoge beschikbaarheid, maar kunnen 24/7 beschikbaarheid zonder storingen niet garanderen en niet op ieder apparaat.
                </p>
                <h3 className="mt-8 text-xl font-semibold">9.1 Onderhoud</h3>
                <p>
                ...
                <h3 className="mt-8 text-xl font-semibold">9.2 Functionaliteiten</h3>
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">10. Informatie, rapportages en externe bronnen</h2>
                <p>
                ...
                <p>
                  Onze BTW-berekening tool is uitsluitend bedoeld als hulpmiddel en vormt geen (bindend) financieel advies of boekhouding. Voor professionele boekhouding en belastingadvies dien je altijd een gekwalificeerde accountant of belastingadviseur te raadplegen.
                </p>
                <h3 className="mt-8 text-xl font-semibold">10.1 Helpdesk support</h3>
                <p>
                ...
                <h3 className="mt-8 text-xl font-semibold">10.2 Externe informatie</h3>
                <p>
                  We zijn niet aansprakelijk voor de beschikbaarheid of inhoud van externe websites waarnaar we verwijzen.
                </p>

                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">11. Eigendom van de gegevens die je bij ons invoert</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">12. Privacy en verwerkersovereenkomst</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">13. Jouw verantwoordelijk gebruik</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                  Er gelden enkele regels voor het gebruik van Baasy.
                </p>
                <p>
                ...
                <ul>
                  ...
                  <li>
                    Omzeil geen beveiligings- en authenticatiemaatregelen en verstuur geen ongewenste reclame of spam via Baasy.
                  </li>
                ...
                <p>
                  Baasy wordt door veel ondernemers gebruikt. We vertrouwen erop dat je de dienst verantwoord gebruikt.
                </p>
                <p>
                  We behouden ons het recht voor om accounts te blokkeren of te verwijderen bij substantiële vermoedens van misbruik.
                </p>
                <p>
                  Je mag informatie, afbeeldingen en andere materialen van ons niet zonder toestemming reproduceren. Volledig of gedeeltelijk nabouwen van Baasy is niet toegestaan.
                </p>
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">14. Schending van de voorwaarden</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">15. Overmacht</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">16. Aansprakelijkheid</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">17. Relatie tot andere bedrijven</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                  Baasy is een onafhankelijk bedrijf en staat los van bol.com B.V. en dochterondernemingen van deze rechtspersoon. Wij zijn geen dochteronderneming van bol.com B.V. en hebben geen (juridische of zakelijke) relatie met bol.com B.V..
                </p>

                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">18. Wijzigingen in deze voorwaarden</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
                ...
                <h2 className="mt-10 text-2xl sm:text-3xl font-semibold">19. Oplossen van geschillen</h2>
                <div className="mt-4 mb-6 h-px w-1/3 bg-gradient-to-r from-border via-border/50 to-transparent" />
                <p>
