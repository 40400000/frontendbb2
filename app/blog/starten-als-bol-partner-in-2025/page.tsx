            ...
            <div className="grid grid-cols-1 sm:grid-cols-4">
              <div className="sm:col-start-1 sm:col-span-4">
                ...
                <div className="bg-red-50 p-6 rounded-xl border border-red-200 mb-6">
                  <h4 className="font-semibold text-lg mb-3 text-[#111111]">⚠️ Wat er mis gaat zonder goede voorbereiding:</h4>
                ...
                <p className="text-lg text-[#111111] mb-6">Het goede nieuws? Met de juiste volgorde en praktische tips kun je binnen een kleine week alles op orde hebben. En als je het goed doet, hoef je er later nooit meer naar om te kijken. In één keer goed regelen dus!</p>
                <p className="text-lg text-[#111111] mb-6">Hier is jouw complete stappenplan:</p>

                <div className="bg-green-50 p-6 rounded-xl border border-green-200 mb-8">
                  <h4 className="font-semibold text-lg mb-3 text-[#111111]">🎯 Jouw 6-stappen checklist om goed af te trappen op bol.com:</h4>
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-[#111111]">KVK-inschrijving met juiste SBI-codes (zie hieronder)</h5>
                        <p className="text-sm text-[#111111]/80">Verplicht voor bol.com partner account</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-[#111111]">Btw-status bepalen</h5>
                        <p className="text-sm text-[#111111]/80">Kleine ondernemersregeling of btw-plichtig?</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      <div className="flex-shrink-0 w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold">3</div>
                      <div>
                        <h5 className="font-semibold text-[#111111]">Bol.com eis: facturen versturen</h5>
                        <p className="text-sm text-[#111111]/80">Klanten die factuur vragen, moeten binnen 24u correcte btw-factuur krijgen</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      <div className="flex-shrink-0 w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold">4</div>
                      <div>
                        <h5 className="font-semibold text-[#111111]">Bol.com eis: bedrijfsgegevens correct</h5>
                        <p className="text-sm text-[#111111]/80">KVK-nummer, btw-nummer en contactgegevens in je partner account zetten</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-[#111111]">Wettelijke eis: btw-aangifte doen</h5>
                        <p className="text-sm text-[#111111]/80">Kwartaal btw-aangifte bij Belastingdienst (als je btw-plichtig bent)</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-[#111111]">Wettelijke eis: administratie bijhouden</h5>
                        <p className="text-sm text-[#111111]/80">7 jaar bewaren van facturen en btw-berekeningen</p>
                      </div>
                    </div>
                  </div>
                </div>

                <h2 className="text-[28px] md:text-[36px] leading-[32px] md:leading-[40px] font-normal text-[#111111] mt-10 mb-6">Stap 1: KVK-inschrijving - je verplichte startdocument</h2>
                <p className="text-lg text-[#111111] mb-6">Zonder geldig KVK-nummer kun je geen bol.com partner account aanmaken. Dit is hard requirement nummer één. Maar let op: niet elke KVK-inschrijving is geschikt voor e-commerce.</p>
                    
                <div className="bg-blue-50 p-6 rounded-xl border border-blue-200 mb-6">
                  <h4 className="font-semibold text-lg mb-3 text-[#111111]">📋 Complete KVK-inschrijving checklist:</h4>
                  ...
                  <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    <h5 className="font-semibold text-base mb-3 text-[#111111]">💡 Cruciale tip: kies de juiste SBI-codes</h5>
                    <div className="space-y-3 text-[#111111]">
                      <div><strong>Hoofdactiviteit:</strong> <code className="bg-gray-100 px-2 py-1 rounded">47919</code> - Detailhandel via internet in overige non-food</div>
                      <div><strong>Extra activiteiten (optioneel):</strong></div>
                      <ul className="text-sm space-y-1 ml-4">
                        <li>• <code className="bg-gray-100 px-2 py-1 rounded">46901</code> - Handel in computers, randapparatuur en software</li>
                        <li>• <code className="bg-gray-100 px-2 py-1 rounded">47789</code> - Overige detailhandel in nieuwe artikelen</li>
                      </ul>
                      <p className="text-sm text-[#111111]/80 mt-2">Deze combinatie dekt vrijwel alle producten die je via bol.com kunt verkopen.</p>
                    </div>
                  </div>
                </div>

                <h2 className="text-[28px] md:text-[36px] leading-[32px] md:leading-[40px] font-normal text-[#111111] mt-10 mb-6">Stap 2: Btw-status strategisch bepalen</h2>
                <p className="text-lg text-[#111111] mb-6">Bij je KVK-inschrijving krijg je automatisch een btw-nummer, maar je moet nog kiezen: kleine ondernemersregeling of direct btw-plichtig? Deze keuze bepaalt je hele administratie. Het een is niet per se beter dan het ander, maar het is belangrijk dat je weet wat je kiest.</p>
                    
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="p-6 bg-yellow-50 rounded-lg border border-yellow-200">
                    <h4 className="font-semibold text-lg mb-3 text-[#111111]">🏠 Kleine ondernemersregeling</h4>
                  ...
                  <div className="p-6 bg-green-50 rounded-lg border border-green-200">
                    <h4 className="font-semibold text-lg mb-3 text-[#111111]">💼 Direct btw-plichtig</h4>
                    <div className="space-y-2 text-sm text-[#111111]">
                ...
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6">
                  <h4 className="font-semibold text-lg mb-3 text-[#111111]">💡 Praktische tip: btw-tarieven per productcategorie</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-[#111111]">
                    <div>
                      <h5 className="font-semibold mb-2 text-red-700">21% (hoog tarief)</h5>
                      <ul className="space-y-1">
                        <li>• Elektronica</li>
                        <li>• Kleding</li>
                        <li>• Speelgoed</li>
                    ...
                    <div>
                      <h5 className="font-semibold mb-2 text-orange-700">9% (laag tarief)</h5>
                      <ul className="space-y-1">
                    ...
                    <div>
                      <h5 className="font-semibold mb-2 text-green-700">0% (of vrijgesteld)</h5>
                      <ul className="space-y-1">
                        <li>• Bepaalde specifieke producten</li>
                      </ul>
                    </div>
                  </div>
                  <p className="text-sm text-[#111111]/80 mt-4">Bij twijfel over tarieven: raadpleeg de <Link href="https://www.belastingdienst.nl/wps/wcm/connect/bldcontentnl/belastingdienst/zakelijk/btw/tarieven_en_vrijstellingen/goederen_9_btw/" target="_blank" rel="noopener noreferrer" className="underline">officiële lijst van de Belastingdienst</Link>.</p>
                </div>

                <h2 className="text-[28px] md:text-[36px] leading-[32px] md:leading-[40px] font-normal text-[#111111] mt-10 mb-6">Stap 3: Bol.com eis - facturen versturen aan klanten</h2>
                <p className="text-lg text-[#111111] mb-6">Als bol.com partner ben je verplicht om facturen te versturen aan klanten die daarom vragen. Dit is een harde eis van bol.com - als je dit niet doet, kan je account geblokkeerd worden. Klanten verwachten hun factuur binnen 24 uur.</p>
                    
                <div className="bg-red-50 p-6 rounded-lg border border-red-200 mb-6">
                  <h4 className="font-semibold text-lg mb-3 text-[#111111]">🚨 Bol.com factuurvereisten die je moet nakomen:</h4>
                  <div className="space-y-2 text-sm text-[#111111]">
                ...
                <h2 className="text-[28px] md:text-[36px] leading-[32px] md:leading-[40px] font-normal text-[#111111] mt-10 mb-6">Stap 4: Bol.com eis - bedrijfsgegevens correct instellen</h2>
                <p className="text-lg text-[#111111] mb-6">Bol.com vereist dat je bedrijfsgegevens compleet en correct zijn ingevuld in je partner profiel. Dit is niet alleen voor verificatie - klanten zien deze gegevens ook, en zakelijke klanten gebruiken ze voor hun eigen administratie.</p>
                    
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6">
                  <h4 className="font-semibold text-lg mb-3 text-[#111111]">📋 Verplichte gegevens in je bol.com partner profiel:</h4>
                ...
                <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200 mb-6">
                  <h4 className="font-semibold text-lg mb-3 text-[#111111]">⚠️ Gevolgen van onjuiste gegevens:</h4>
                  <div className="space-y-2 text-sm text-[#111111]">
                ...
                <div className="bg-orange-50 p-6 rounded-lg border border-orange-200 mb-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-[#111111]">Kwartaal 1 (jan-mrt)</h5>
                        <p className="text-sm text-[#111111]/80">Aangifte deadline: 30 april</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-[#111111]">Kwartaal 2 (apr-jun)</h5>
                        <p className="text-sm text-[#111111]/80">Aangifte deadline: 31 juli</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-[#111111]">Kwartaal 3 (jul-sep)</h5>
                        <p className="text-sm text-[#111111]/80">Aangifte deadline: 31 oktober</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-[#111111]">Kwartaal 4 (okt-dec)</h5>
                        <p className="text-sm text-[#111111]/80">Aangifte deadline: 31 januari (volgend jaar)</p>
                      </div>
                    </div>
                  </div>
                  <p className="text-sm text-[#111111]/80 mt-4">⚠️ <strong>Let op:</strong> Te late aangifte = dure boetes, naheffingen en rente op je btw-schuld</p>
                </div>

                <div className="bg-red-50 p-6 rounded-lg border border-red-200 mb-6">
                  <h4 className="font-semibold text-lg mb-3 text-[#111111]">🧮 Wat je moet berekenen voor je btw-aangifte:</h4>
                  <div className="space-y-3 text-sm text-[#111111]">
                ...
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-6 mt-12">
                  ...
                  <div className="mt-4">
                    <h5 className="font-semibold mb-2 text-[#111111]">Administratie & belastingen:</h5>
