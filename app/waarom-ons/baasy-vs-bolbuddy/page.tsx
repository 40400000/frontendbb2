...
export const metadata: Metadata = {
  ...
  description: "Vergelijk Baasy met Bolbuddy. Ontdek waarom onze partners kiezen voor meer functies, 12M+ keywords database, AI tools en complete automatisering. Probeer 14 dagen gratis.",
  keywords: [
            ...
            <div className="text-left">
              ...
              <div className="space-y-5 mb-8">
                ...
                <p className="text-[14px] md:text-[16px] leading-[18px] md:leading-[21px] font-normal text-[#111111]/80 max-w-2xl">
                  Ontdek welke keywords en producten écht werken, met 12 miljoen geanalyseerde zoektermen en miljarden datapunten.
                </p>
              </div>
