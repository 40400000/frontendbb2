...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/waarom-ons/baasy-vs-bolmate",
  },
  openGraph: {
    title: "Baasy vs Bolmate: Het Beste Alternatief voor Bol Partners",
    description: "Vergelijk Baasy met Bolmate. Ontdek waarom tevreden partners kiezen voor onbeperkte orders, 12M+ keywords database, AI tools en complete automatisering.",
    url: "/waarom-ons/baasy-vs-bolmate",
    siteName: "Baasy",
    locale: "nl_NL",
    type: "website",
    images: [
        ...
        <div className="container mx-auto max-w-2xl px-4 md:px-6">
          ...
          <div className="space-y-0">
            ...
            <ComparisonAccordionItem 
              ...
              baasyContent="Bij Baasy betaal je slechts €9 per maand voor onbeperkt orders, e-mails en facturen. De prijs blijft altijd hetzelfde, ongeacht hoeveel orders je verwerkt. Geen verrassingen, geen extra kosten bij groei - gewoon een vaste, lage prijs."
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="max-w-5xl mx-auto mt-6 md:mt-8">
            <p className="text-center text-[11px] md:text-xs text-gray-500 italic">
              Baasy Plus vergeleken met Bolmate 200 orders abonnement
            </p>
