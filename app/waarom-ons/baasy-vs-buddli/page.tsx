...
export const metadata: Metadata = {
  ...
  description: "Vergelijk Baasy met Buddli. Ontdek waarom onze partners kiezen voor meer functies, 12M+ keywords database, AI tools en complete automatisering. Probeer 14 dagen gratis.",
  keywords: [
    "Buddli alternatief",
    "Baasy vs Buddli",
    "Buddli alternatief",
