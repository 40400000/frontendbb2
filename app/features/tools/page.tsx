        ...
        <section className="relative z-10 w-full pb-10 md:pb-16 lg:pb-20">
            ...
            <div className="relative z-60"> {/* REMOVED container padding */}
              ...
              <div className="absolute top-[23%] sm:top-[0%] sm:right-[-10%] w-full sm:w-[75%] h-auto z-70 pointer-events-none"> {/* Adjusted top/right positioning */} 
                <Image
                  src="https://vhtnlfbnq3ecybmn.public.blob.vercel-storage.com/database_2-tpY5QwEZ6u13BvTDUraKrhQjnwtMUj-H8r9D7W4P0UsdN1qL5BLUrV796fc2w.png"
          ...
          <section id="ranking-ai" className="relative w-full pt-32 pb-60 "> {/* Standard section padding + INCREASED min-h */}
            ...
            <div className="relative z-60"> {/* REMOVED container padding */}
              ...
              {/* NEW Absolutely Positioned Image Container for Product Prestaties */}
              <div className="absolute top-[86%] sm:top-[0%] sm:right-[-10%] w-full sm:w-[75%] h-auto z-70 pointer-events-none"> {/* Adjusted top/right positioning */} 
                <Image
