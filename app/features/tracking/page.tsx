  ...
  return (
    <>
        ...
        <section className="relative z-10 w-full pb-10 md:pb-16 lg:pb-20">
          ...
          <section data-navbar-mode="light" className="relative w-full py-16 md:py-24 lg:py-32 min-h-[385vh]"> {/* Further increased section height */}
            ...
            <div className="relative z-60"> {/* REMOVED container padding */}
              ...
              <div className="grid grid-cols-[25%_25%_25%_25%] gap-x-0 gap-y-6 text-white"> {/* Updated grid definition, added gap-y-6 */}
                ...
                <div className="text-black row-span-2 z-80 relative"> {/* Span container across two rows */}
                  ...
                  <div className="w-full">
                    ...
                    <div className="mt-[42rem] z-80 relative pt-10">
                      <div className="absolute top-[40rem] left-0 w-full z-80 pt-10">
              ...
              <div className="absolute left-[25%] top-[70%] w-[50%] flex justify-start items-center text-black text-5xl font-semibold z-80"> {/* Made 'Twee soorten' much larger */}
                Tracking opties
              </div>
              {/* Precision Label - Replaced with Feature 02 content */}
              <div className="absolute left-[25%] top-[78%] w-[25%] z-80 text-left text-black"> {/* Adjusted classes: removed flex, items-center, text-4xl, font-bold. Added text-left */}
              ...
              <div className="absolute left-[50%] top-[78%] w-[25%] z-80 text-left text-black"> {/* Adjusted classes: removed flex, items-center, text-4xl, font-bold. Added text-left */}
              ...
              {/* End dynamic label */}
              <div className="absolute top-[105%] left-1/2 transform -translate-x-1/2 w-[40%] h-auto z-70 pointer-events-none">
                <Image
              ...
              <div className="absolute top-[150%] right-[-10%] w-[75%] h-auto z-70 pointer-events-none">
                <Image
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 top-[86%] w-[50%] z-80 text-left text-black space-y-6"> {/* Added text-black and space-y-4 */}
      ...
      <div className="container w-full relative z-80">
        ...
        {/* Grid layout */}
        <div className="grid grid-cols-[25%_25%_25%_25%] gap-x-0 gap-y-6 text-white mt-8">
          ...
          <div></div>
              ...
              {/* Feature Set 1 */}
              <div className="mt-6 z-80 relative w-[25%]">
        ...
        <div className="absolute top-[30%] right-[-10%] w-[75%] h-auto pointer-events-none flex items-center justify-center">
